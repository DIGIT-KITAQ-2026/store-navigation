    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="store-search-card-content mx-auto flex w-full max-w-2xl flex-1 flex-col items-center justify-center gap-6 px-4 pb-[max(2rem,env(safe-area-inset-bottom))] text-center md:max-w-4xl">
            <form
              method="GET"
              action="/search"
              role="search"
